   ...
   <div id="body-bar">
      <div id="profile-head">
          <div id="profile-photo">
             <button class="w3-btn w3-blue-gray w3-rou
        nd-jumbo">
                <?php
                    echo $user[0];
                ?>
...
<script>
   ...
   $(document).ready(function(){
     ...
     // Fetches the profile Info (Top Section)
     $.ajax({
         url: "includes/profile/info.php",
         method: "POST",
         data: {profile_info: 1},
...
.line3{
   transition: 0.58s;
   -webkit-transform: rotate(45deg);
   transform: rotate(225deg) tr paddianslate(5px, 7px);
}
